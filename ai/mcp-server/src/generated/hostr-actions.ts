...
export const HostrProfileEditInputSchema = z.object({
  ...
  "image": z.string().describe("Profile image URL. For user-uploaded files, first call hostr_images_upload and pass structuredContent.usage.profileImage.url here. Do not pass local paths, file:// URLs, ChatGPT upload refs, or base64 data directly.").optional(),
  "picture": z.string().describe("Alias for image. For user-uploaded files, first call hostr_images_upload and pass structuredContent.usage.profileImage.url here. Do not pass local paths, file:// URLs, ChatGPT upload refs, or base64 data directly.").optional(),
