...
void main() {
  ...
  OrderParticipantProofTag proofTag({
    ...
    return OrderParticipantProofTag(
      ...
      payloadHash:
          payloadHash ??
          OrderParticipantProofTag.hashPayload(plaintext ?? payload),
      payload: payload,
    );
  }

  group('DefaultOrderParticipantKeyring', () {
    test('controls the active identity pubkey without trade lookup', () async {
      final allocator = _FakeTradeAccountAllocator();
      final keyring = DefaultOrderParticipantKeyring(
        auth: _FakeAuth(
  ...
  group('KeyPairOrderParticipantKeyring', () {
    test('controls configured keypairs without trade lookup', () async {
      final keyring = KeyPairOrderParticipantKeyring(
