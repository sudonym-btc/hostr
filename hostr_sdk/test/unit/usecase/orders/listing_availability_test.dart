...
void main() {
  group('Listing availability with mock data', () {
    ...
    test(
      'cancelled commitment hash is skipped by subscribeUncancelledOrders',
      () async {
        const keepCommitment = 'trade-keep';
        const dropCommitment = 'trade-drop';

        final keep = await _order(
          listing: listing,
          signer: MockKeys.hoster,
        ...
        final droppedOriginal = await _order(
          listing: listing,
        ...
        final droppedCancelled = await _order(
          listing: listing,
          signer: MockKeys.hoster,
          tradeId: dropCommitment,
          start: start,
        ...
        final validated = usecase.subscribeUncancelledOrders(
          listing: listing,
