...
class TestSeedHelper {
      ...
      if (threads.isNotEmpty) {
        ...
        if (threadStages != null) {
          thread = SeedThread(
            ...
            guestTradeAccountIndex: thread.guestTradeAccountIndex,
            requestAuthorKeyPair: thread.requestAuthorKeyPair,
            id: thread.id,
            start: thread.start,
            end: thread.end,
  ...
  Future<SeedThread> freshThread({
    ...
    return SeedThread(
      ...
      listing: t.listing,
      request: t.request,
      guestTradeAccountIndex: t.guestTradeAccountIndex,
      requestAuthorKeyPair: t.requestAuthorKeyPair,
      id: t.id,
      start: t.start,
      end: t.end,
      stageSpec: threadStages,
