...
const Map<_ListingTheme, List<String>> _themeImageUrls = {
  _ListingTheme.urban: [
    // Modern apartments & city interiors
    ...
    // Kitchens, living rooms & workspaces
  ...
  _ListingTheme.cozy: [
    // Cabins, fireplaces & warm interiors
    ...
    // Countryside retreats & nature stays
    ...
    // Rustic rooms & woodland hideaways
  ...
  _ListingTheme.boutique: [
    // Boutique hotels & designer suites
    ...
    // Lobbies, rooftops & premium amenities
  ...
  _ListingTheme.coastal: [
    ...
    // Tropical bungalows & waterfront stays
    ...
    // Seaside pools, sunsets & resort views
...
const List<({String city, double latitude, double longitude})> _landSeedPoints =
    [
