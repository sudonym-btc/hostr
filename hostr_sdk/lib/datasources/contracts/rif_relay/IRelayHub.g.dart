...
class IRelayHub extends _i1.GeneratedContract {
  ...
  Future<String> deployCall(
    ...
    assert(checkSignature(function, '17014457'));
    final params = [
      args.deployRequest,
      args.signature,
    ];
  ...
  Future<BigInt> workerCount(
    ({_i2.EthereumAddress manager}) args, {
    _i1.BlockNum? atBlock,
  }) async {
    final function = self.abi.functions[18];
    assert(checkSignature(function, '194ac307'));
    final params = [args.manager];
    final response = await read(
      function,
      params,
      atBlock,
  ...
  Future<_i3.Uint8List> workerToManager(
    ({_i2.EthereumAddress worker}) args, {
    _i1.BlockNum? atBlock,
  }) async {
    final function = self.abi.functions[19];
    assert(checkSignature(function, 'ca998f56'));
    final params = [args.worker];
    final response = await read(
      function,
      params,
      atBlock,
