...
class BoltzSmartWalletFactory extends _i1.GeneratedContract {
  ...
  Future<String> createUserSmartWallet(
    ...
    assert(checkSignature(function, 'dc89745f'));
    final params = [
      args.owner,
      args.recoverer,
      args.index,
  ...
  Future<_i2.EthereumAddress> getSmartWalletAddress(
    ...
    assert(checkSignature(function, '6088665e'));
    final params = [
      args.owner,
      args.recoverer,
      args.index,
