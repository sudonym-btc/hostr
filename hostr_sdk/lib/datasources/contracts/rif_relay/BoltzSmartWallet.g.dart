...
class BoltzSmartWallet extends _i1.GeneratedContract {
  ...
  Future<String> initialize(
    ({
      ...
      _i2.EthereumAddress tokenContract,
      _i2.EthereumAddress feesReceiver,
      BigInt tokenAmount,
      BigInt tokenGas,
    ...
    assert(checkSignature(function, 'c07adbdc'));
    final params = [
      args.owner,
      args.tokenContract,
      args.feesReceiver,
