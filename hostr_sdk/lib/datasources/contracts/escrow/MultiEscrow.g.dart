...
class MultiEscrow extends _i1.GeneratedContract {
  ...
  Future<String> claimSwapAndFund(
    ...
    assert(checkSignature(function, 'd6171757'));
    final params = [
      args.claimArgs,
      args.fundArgs,
    ];
