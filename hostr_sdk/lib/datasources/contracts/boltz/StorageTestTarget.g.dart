...
class StorageTestTarget extends _i1.GeneratedContract {
  ...
  /// set by the contract.
  Future<String> expectRevertStorageConst({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[1];
    assert(checkSignature(function, 'fc5aec2b'));
    final params = [];
    return write(
      credentials,
      transaction,
