...
class EtherSwapTest extends _i1.GeneratedContract {
  ...
  Future<String> testLock({
    ...
    assert(checkSignature(function, 'e96d88e0'));
    final params = [];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testLockWithRefundAddress({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[29];
    assert(checkSignature(function, '9c06bd0b'));
    final params = [];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testLockupPrepayMinerFeeEqValueFail({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[33];
    assert(checkSignature(function, 'bc70df52'));
    final params = [];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testLockupPrepayMinerFeeGtValueFail({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[34];
    assert(checkSignature(function, '42b526d8'));
    final params = [];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testNoSendEtherWithoutFunctionSig({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[35];
    assert(checkSignature(function, 'cce79235'));
    final params = [];
    return write(
      credentials,
      transaction,
