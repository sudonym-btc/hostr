...
ThemeData getTheme(bool isDark) {
  final darkColorScheme =
      ColorScheme.fromSwatch(
        ...
        secondaryContainer: const Color(0xFF102A55),
        onSecondaryContainer: const Color(0xFFDCE8FF),
        ...
        // The surface-container ramp must have evenly-spaced, distinct
        // values so that AppSurface.stepped() / AppSurface produce a
        // visible colour change at every step.  The default M3 ramp
        // generated by ColorScheme.fromSwatch collapses several tokens
        // to the same value (e.g. surface == surfaceContainerLowest),
        // which makes stepped surfaces invisible.
        surfaceDim: const Color(0xFF0C0C0C),
  ...
  final lightColorScheme =
      ColorScheme.fromSwatch(
        ...
        onSecondaryContainer: const Color(0xFF14386B),
