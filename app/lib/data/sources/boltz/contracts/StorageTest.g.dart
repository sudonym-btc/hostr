...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<_i2.Uint8List> const({_i1.BlockNum? atBlock}) async  { final function = self.abi.functions  [
2
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> deep_map(({_i1.EthereumAddress $param0, _i1.EthereumAddress $param1}) args, {_i1.BlockNum? atBlock, }) async  { final function = self.abi.functions  [
3
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<Deep_map_struct> deep_map_struct(({_i1.EthereumAddress $param2, _i1.EthereumAddress $param3}) args, {_i1.BlockNum? atBlock, }) async  { final function = self.abi.functions  [
4
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<_i2.Uint8List> extra_sload({_i1.BlockNum? atBlock}) async  { final function = self.abi.functions  [
7
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<_i2.Uint8List> hidden({_i1.BlockNum? atBlock}) async  { final function = self.abi.functions  [
10
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> map_addr(({_i1.EthereumAddress $param10}) args, {_i1.BlockNum? atBlock, }) async  { final function = self.abi.functions  [
11
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<bool> map_bool(({_i1.EthereumAddress $param11}) args, {_i1.BlockNum? atBlock, }) async  { final function = self.abi.functions  [
12
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> map_packed(({_i1.EthereumAddress $param12}) args, {_i1.BlockNum? atBlock, }) async  { final function = self.abi.functions  [
13
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<Map_struct> map_struct(({_i1.EthereumAddress $param13}) args, {_i1.BlockNum? atBlock, }) async  { final function = self.abi.functions  [
14
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> read_struct_lower(({_i1.EthereumAddress who}) args, {_i1.BlockNum? atBlock, }) async  { final function = self.abi.functions  [
16
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<BigInt> read_struct_upper(({_i1.EthereumAddress who}) args, {_i1.BlockNum? atBlock, }) async  { final function = self.abi.functions  [
17
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<_i2.Uint8List> tE({_i1.BlockNum? atBlock}) async  { final function = self.abi.functions  [
24
];
...
/// set, the function will be evaluated in the specified block. By default, the
/// latest on-chain block will be used.
Future<_i1.EthereumAddress> tF({_i1.BlockNum? atBlock}) async  { final function = self.abi.functions  [
25
];
