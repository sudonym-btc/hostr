...
class EtherSwapFuzzTest extends _i1.GeneratedContract {
  ...
  Future<void> testHashValuesMatchesKeccak256(
    ...
    assert(checkSignature(function, '1878ece6'));
    final params = [
      args.preimageHash,
      args.amount,
      args.claimAddress,
