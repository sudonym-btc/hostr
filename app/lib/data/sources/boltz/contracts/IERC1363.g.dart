...
class IERC1363 extends _i1.GeneratedContract {
  IERC1363({
  ...
  Future<String> approveAndCall(
    ...
    assert(checkSignature(function, '3177029f'));
    final params = [
      args.spender,
      args.value,
    ];
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> approveAndCall$2(
    ({_i2.EthereumAddress spender, BigInt value, _i3.Uint8List data}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> transferAndCall(
    ({_i2.EthereumAddress to, BigInt value}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[8];
    assert(checkSignature(function, '1296ee62'));
    final params = [
      args.to,
      args.value,
    ];
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> transferAndCall$2(
    ({_i2.EthereumAddress to, BigInt value, _i3.Uint8List data}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[9];
    assert(checkSignature(function, '4000aea0'));
    final params = [
      args.to,
      args.value,
      args.data,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> transferFromAndCall(
    ({
    ...
    assert(checkSignature(function, 'c1d34b89'));
    final params = [
      args.from,
      args.to,
      args.value,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> transferFromAndCall$2(
    ({_i2.EthereumAddress from, _i2.EthereumAddress to, BigInt value}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[12];
    assert(checkSignature(function, 'd8fbe994'));
    final params = [
      args.from,
      args.to,
      args.value,
