...
class StdMathMock extends _i1.GeneratedContract {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> exposed_percentDelta(
    ({BigInt a, BigInt b}) args, {
    _i1.BlockNum? atBlock,
  }) async {
    final function = self.abi.functions[5];
    assert(checkSignature(function, 'd10b30fc'));
    final params = [
      args.a,
      args.b,
    ];
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> exposed_percentDelta$2(
    ({BigInt a, BigInt b}) args, {
    _i1.BlockNum? atBlock,
  }) async {
    final function = self.abi.functions[6];
    assert(checkSignature(function, 'f52a926b'));
    final params = [
      args.a,
      args.b,
    ];
