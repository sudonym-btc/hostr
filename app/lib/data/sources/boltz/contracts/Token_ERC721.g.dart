...
class Token_ERC721 extends _i1.GeneratedContract {
  ...
  Future<String> approve(
    ({_i1.EthereumAddress spender, BigInt id}) args, {
  ...
  Future<String> initialize(
    ({String name_, String symbol_}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> safeMint(
    ({_i1.EthereumAddress to, BigInt tokenId, _i2.Uint8List data}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[10];
    assert(checkSignature(function, '8832e6e3'));
    final params = [
      args.to,
      args.tokenId,
      args.data,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> safeMint$2(
    ({_i1.EthereumAddress to, BigInt tokenId}) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[11];
    assert(checkSignature(function, 'a1448194'));
    final params = [
      args.to,
      args.tokenId,
    ];
