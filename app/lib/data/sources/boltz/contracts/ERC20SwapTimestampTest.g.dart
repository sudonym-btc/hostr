...
class ERC20SwapTimestampTest extends _i1.GeneratedContract {
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testRefundFailsOneSecondBeforeTimeout({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[13];
    assert(checkSignature(function, '8acf44f5'));
    final params = [];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testRefundSucceedsAtExactTimeout({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[14];
    assert(checkSignature(function, 'cfb9bf83'));
    final params = [];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testRefundSucceedsLongAfterTimeout({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[15];
    assert(checkSignature(function, 'e35ab90f'));
    final params = [];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testRefundSucceedsOneSecondAfterTimeout({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[16];
    assert(checkSignature(function, 'ae49d5c9'));
    final params = [];
    return write(
      credentials,
      transaction,
