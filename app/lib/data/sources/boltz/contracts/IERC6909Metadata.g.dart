...
class IERC6909Metadata extends _i1.GeneratedContract {
  IERC6909Metadata({
  ...
  Future<BigInt> decimals(
    ...
    assert(checkSignature(function, '3f47e662'));
  ...
  Future<String> name(
    ...
    assert(checkSignature(function, '00ad800c'));
    final params = [args.id];
    final response = await read(
      function,
      params,
  ...
  Future<String> symbol(
    ...
    assert(checkSignature(function, '4e41a1fb'));
    final params = [args.id];
    final response = await read(
      function,
      params,
