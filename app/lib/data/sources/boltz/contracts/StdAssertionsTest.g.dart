...
class StdAssertionsTest extends _i1.GeneratedContract {
  ...
  /// set by the contract.
  Future<String> assertEqCallExternal(
    ({
      _i1.EthereumAddress targetA,
      _i2.Uint8List callDataA,
      _i1.EthereumAddress targetB,
      _i2.Uint8List callDataB,
    ...
    assert(checkSignature(function, '037d9c4d'));
    final params = [
      args.targetA,
      args.callDataA,
      args.targetB,
      args.callDataB,
      args.strictRevertData,
    ];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testFailFail({
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[2];
    assert(checkSignature(function, '002006ee'));
    final params = [];
    return write(
      credentials,
      transaction,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testFuzz_AssertEqCall_Return_Pass(
    ({
      _i2.Uint8List callDataA,
      _i2.Uint8List callDataB,
    ...
    assert(checkSignature(function, '80504c7b'));
    final params = [
      args.callDataA,
      args.callDataB,
      args.returnData,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testFuzz_AssertEqCall_Revert_Pass(
    ({
      _i2.Uint8List callDataA,
      _i2.Uint8List callDataB,
      _i2.Uint8List revertDataA,
      _i2.Uint8List revertDataB
    }) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
  }) async {
    final function = self.abi.functions[4];
    assert(checkSignature(function, '0a98ff22'));
    final params = [
      args.callDataA,
      args.callDataB,
      args.revertDataA,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testFuzz_RevertWhenCalled_AssertEqCall_Fail(
    ({
      _i2.Uint8List callDataA,
      _i2.Uint8List callDataB,
      _i2.Uint8List returnDataA,
      _i2.Uint8List returnDataB,
      bool strictRevertData
    }) args, {
    required _i1.Credentials credentials,
    _i1.Transaction? transaction,
    ...
    assert(checkSignature(function, '8ba0a893'));
    final params = [
      args.callDataA,
      args.callDataB,
      args.returnDataA,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testFuzz_RevertWhenCalled_AssertEqCall_Return_Fail(
    ({
      _i2.Uint8List callDataA,
      _i2.Uint8List callDataB,
      _i2.Uint8List returnDataA,
    ...
    assert(checkSignature(function, 'afabe8c6'));
    final params = [
      args.callDataA,
      args.callDataB,
      args.returnDataA,
  ...
  /// like the gas price, nonce and max gas. The `data` and `to` fields will be
  /// set by the contract.
  Future<String> testFuzz_RevertWhenCalled_AssertEqCall_Revert_Fail(
    ({
      _i2.Uint8List callDataA,
      _i2.Uint8List callDataB,
      _i2.Uint8List revertDataA,
    ...
    assert(checkSignature(function, '110b94c5'));
    final params = [
      args.callDataA,
      args.callDataB,
      args.revertDataA,
